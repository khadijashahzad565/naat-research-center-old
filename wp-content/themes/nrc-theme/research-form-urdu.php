...
<main class="research-submission-page">
  <section class="research-hero">
    <h1>
      ...
      <span class="english-title">Submit Your Research Work</span>
    </h1>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            ...
            submitBtn.value = 'جمع کیا جا رہا ہے...';
            ...
            if (!title || !category || !content || !author || !email || !date || !file) {
                notifications.showToast('error', 'توثیق کی خرابی', 'براہ کرم تمام ضروری خانے بھریں۔');
                submitBtn.disabled = false;
                submitBtn.value = 'تحقیق جمع کریں';
                return;
            }
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    const errorMessage = data.data && data.data.message 
                        ? data.data.message 
                        : 'تحقیق جمع کرتے وقت خرابی ہوئی۔';
                    notifications.showModal('error', 'خرابی!', errorMessage);
                }
            })
            .catch(error => {
                console.error('Submission error:', error);
                notifications.showModal('error', 'خرابی!', 'کچھ غلط ہو گیا۔ اپنا انٹرنیٹ کنکشن چیک کریں اور دوبارہ کوشش کریں۔');
            })
            .finally(() => {
                submitBtn.disabled = false;
                submitBtn.value = 'تحقیق جمع کریں';
