    ...
    <div class="research-form-wrapper">
      ...
      <form method="post" enctype="multipart/form-data" id="research-form">
        ...
        <div class="form-group">
          ...
          <div class="error-message">Please enter a research title</div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="error-message">Please provide research details</div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="error-message">Please select a submission date</div>
        </div>
        ...
        form.addEventListener('submit', function(e) {
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    setTimeout(() => {
                        notifications.showModal('success', 'Success!', data.data.message || 'Your research has been submitted successfully.');
                    }, 1500);
                    ...
                    notifications.showModal('error', 'Error!', data.data?.message || 'An error occurred while submitting your research.');
                }
            })
            .catch(error => {
